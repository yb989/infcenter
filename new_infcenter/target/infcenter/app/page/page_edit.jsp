  	...
  	<form id="pageFrom" class="easyui-form" method="post" modelAttribute="page">
		...
		<table class="tableForm" border="0" width="100%">
			<tr>
				...
				<td align="left">
					<input id="pageName" name="pageName" class="easyui-textbox" value="${page.pageName}" data-options="required:true,validType:['length[0,30]','chineseRule']" style="width: 175px;height: 24px;"/>&nbsp;&nbsp;
