...
<%--			    <td colspan="3">--%>
<%--			        <input type="radio" id="isIndex1" name="isIndex" value="0" <c:if test="${map.isIndex=='0'}">checked</c:if>/><label for="isIndex1">否</label>--%>
<%--					<input type="radio" id="isIndex2" name="isIndex" value="1" <c:if test="${map.isIndex=='1'}">checked</c:if>/><label for="isIndex2">是</label>--%>
<%--			   	</td>--%>
<%--			 </tr>--%>
<%--			 <tr>--%>
...
<%--						<div>--%>
<%--							<ol class="files">--%>
<%--							   <img id="indexImgs" src="${app }/indexImg/${map.indexUrl}" />--%>
<%--							</ol>--%>
<%--						</div>--%>
<%--					</div>--%>
