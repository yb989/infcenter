...
<html>
	...
	<body class="easyui-layout" style="width: 100%; height: 100%;">
		<div id="head" region="north">
			<span id="logo" style="vertical-align: middle;margin:8 0 0 -93;"><img src="${app}/images/logo_infcenter.jpg" /></span>
			<ul id="contact">   
		...
		<div region="south" border="false" class="cs-south"><font style="color: #999;font-size: 13px;">Copyright © 2015-2016 All rights reserved</font> </div>
